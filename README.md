...
<img src="Robotic-arm.PNG" align="right" width="400" />
...
# 4. Processing 3D 
I suggest you to use the knowledge developed in previous programs to try to create a 3D representation of the robotic arm and set up all. you can later look at this solution to understand all the tricks I used. When you look at my code focus on lights of the 3D drawing, translations and rotations. Prerequisites and instructions are the same as in the previous chapter.
